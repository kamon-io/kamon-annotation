...
//
//  @After("execution((@kamon.annotation.api.EnableKamon AnnotationInstruments+).new(..)) && this(obj)")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Trace !static * (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Segment !static * (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Timer !static * (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Count !static * (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.RangeSampler !static * (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)")
...
//  }
//
//  @AfterReturning(pointcut = "execution(@kamon.annotation.api.Histogram !static (int || long || double || float) (@kamon.annotation.api.EnableKamon AnnotationInstruments+).*(..)) && this(obj)", returning = "result")
