...
//  }
//
//  @Around("execution(@kamon.annotation.api.Trace static * (@kamon.annotation.api.EnableKamon *).*(..))")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Segment static * (@kamon.annotation.api.EnableKamon *).*(..))")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.Count static * (@kamon.annotation.api.EnableKamon *).*(..))")
...
//  }
//
//  @Around("execution(@kamon.annotation.api.RangeSampler static * (@kamon.annotation.api.EnableKamon *).*(..))")
...
//  }
//
//  @AfterReturning(pointcut = "execution(@kamon.annotation.api.Histogram static (int || long || double || float) (@kamon.annotation.api.EnableKamon *).*(..))", returning = "result")
